...
void SON::SonData()
{
    ...
    cout << "---HELLO WELCOME TO SON INCOME TRACKER---" << endl;
    ...
    cout << "Enter actual and projected cost for Hair  : " << endl;
    ...
    //expenses
    a_expenses = total_a_entertainment + total_a_food + total_a_personal_care + total_a_transport + total_loans + total_insurance + total_a_Education;
    p_expenses = total_p_entertainment + total_p_food + total_p_personal_care + total_p_transport + total_p_Education;
